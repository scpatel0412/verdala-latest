    ...
    constructor(props) {
		...
		this.state = {
            ...
            fields: [
                ...
                {name: "phone", type: "number", placeholder: "Phone", value: null, required: false},
                {name: "email", type: "email", placeholder: "E-Mail*", value: null, required: true},
                {name: "subject", type: "text", placeholder: "Subject", value: null, required: true},
            ...
            if ( field.type === "textarea" ) {
                return (
                    <>
                        <div className="input-field">
                            ...
                            <textarea aria-label={"Insert" + field.placeholder} id={field.name} onChange={this.inputFieldHandler.bind(this, key)} placeholder={field.placeholder} name={field.name} rows="5" />
                        </div>
                    </>
                )
                ...
                return (
                    <>
                        <div className="input-field">
                            <label htmlFor={field.name}>{field.placeholder}</label>
                            <input aria-label={"Insert" + field.placeholder} id={field.name} onChange={this.inputFieldHandler.bind(this, key)} placeholder={field.placeholder} name={field.name} type={field.type} />
                        </div>
                    </>
                )
            }
