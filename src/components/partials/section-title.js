...
return(
    ...
    <div>
        <div className="crow">
            ...
            <div className={props.number=="01" ? "col-5 col-lg-12 col-xl-6 fadeinup": "col-7 col-xl-12 fadeinup"}>
                {(props.title == null) ?
                
                    <p className={ `${Styles.text} ${Styles.secdesc}` }>{props.ptext}</p>
                : 
                    <>
                    <h2 className={ `${Styles.secmaintitle} ${props.customclass=="bquote" ? Styles.bquote :"" }` } data-splitting>{props.title}</h2>
                    {   props.number=="05" &&
