    ...
    <>
        <div className={Styles.propertyMeta}>
            ...
            <div className="row">
                <div className="col-1">
                    <div className={Styles.valueField}>
                        <span><SecondaryText styleClass="inherit-color pb-20" text="Sales Manager"/></span>
                        <span><SecondaryText text="john davies"/></span>
                        <span><SecondaryText text="+2764327081"/></span>
