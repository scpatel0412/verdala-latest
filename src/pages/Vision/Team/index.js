  ...
  return (
    <>
      {visionPage != undefined ? (
        <>
          <section
            className={` vision-tab-inspried-sec page-generic ${Pagegeneric.secgeneric}`}
          >
                ...
                <div className="crow">
                    ...
                    >
                      <div className="sticky-inner">
                        <div className="team-tab-title">
                          <ul>
                            {visionPage?.team_data?.map((item, index2) => {
                              return (
                                <div key={index2}>
                                  <li
                                    className={`anim-scroll-up ${
                                      currentTeamName === index2 && "active"
                                    }`}
                                  >
                                    <a
                  ...
                  <div className="col-9 col-lg-8">
                    <div className="scroll-container">
                      {visionPage?.team_data?.map((i, index2) => {
                        return (
                              ...
                              {i?.team_members?.map((items, index) => {
                                return (
                                  <>
                                    <div
                                      key={index}
                                      className="vison-team-tab-image"
                                    >
                                      <div className="vison-team-tab-image-div">
                                        <img src={items?.member_image?.url} />
                                      </div>
                                      <h4 className="vison-team-tab-title">
                                        {items?.member_name}
                                      </h4>
                                      <p className="vison-team-tab-des">
                                        {items?.position}
                                      </p>
                                    </div>
                                  </>
